...
<body>
                    ...
                    <div class="card mb-0 h-auto">
                        <div class="card-body">
                            <div class="text-center mb-2">
                                <!-- Logo -->
                                <a href="index.html">
                                    <svg width="250" height="56" viewBox="0 0 220 56" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="black" />
                                        <mask id="mask0_131_20" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0"
                                            y="0" width="64" height="56">
                            ...
                            <div class="new-account mt-3 text-center">
                                <p>Don't have an account? <a class="text-primary" href="page-register.html">Sign up</a>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <!-- JS -->
    <script src="{{ asset('commondashboard/vendor/global/global.min.js') }}"></script>
    <script src="{{ asset('vendor/admin/jquery-validation/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('vendor/admin/sweetalert2/dist/sweetalert2.min.js') }}"></script>
                    ...
                    $.ajax({
                        ...
                        error: function (xhr) {
                            ...
                            if (response?.errors) {
                                ...
                                $("#error-message")
                                    .text(response?.message || "Login failed. Try again.")
                                    .attr("style", `
                                        display:block !important;
                                        width:100% !important;
                                        background-color:#f8d7da !important;
