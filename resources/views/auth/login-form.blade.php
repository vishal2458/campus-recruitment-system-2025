...
<body>
    ...
    <div class="card mb-0 h-auto">
        <div class="card-body">
            ...
            <form action="https://edumin.dexignlab.com/laravel/demo/index">
            ...
            <div class="new-account mt-3">
                <p>Don't have an account? <a class="text-primary" href="page-register.html">Sign up</a></p>
                    ...
                    <script src="{{ asset('commonDashBoard/vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}" type="text/javascript"></script>
