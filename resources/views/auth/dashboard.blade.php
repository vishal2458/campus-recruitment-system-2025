...
<!-- Mirrored from edumin.dexignlab.com/laravel/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 16:35:46 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('commonDashbimages/favicon.png') }}">
        ...
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <svg class="logo-abbr" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    width="84" height="67" viewBox="0 0 84 67" fill="none">
                    <mask id="mask0_135_5" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="4" y="0" width="76"
                        height="66">
                ...
                <svg class="brand-title" xmlns="http://www.w3.org/2000/svg" width="122" height="19" viewBox="0 0 122 19"
                    fill="none">
                    <path
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-xxl-6 col-lg-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="morris_bar_stalked" class="morris_chart_height ltr"
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="morris_donught_2" class="morris_chart_height ltr"
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="morris_area" class="morris_chart_height ltr" style="height: 300px !important;">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table verticle-middle text-nowrap table-responsive-md">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>120$</td>
                                                <td>
                                                    <a href="edit-student.html" class="btn btn-xs sharp btn-primary"><i
                                                            class="fa fa-pencil"></i></a>
                                                    <a href="javascript:void(0);" class="btn btn-xs sharp btn-danger"><i
                                                            class="fa fa-trash"></i></a>
                                                </td>
